...
export default class CampfireScene extends BaseScene {
    constructor() {
        ...
        this.sceneSetup.assets = [
            ...
            BaseScene.makeAssetSetup({ src: 'cloud-fog', onUpdate: this.loopRight.bind(this),position: { x: -200, y: -300 }, scale: { x: 4, y: 3.5 }, anchor: { x: 0.5, y: 0.5 }, alpha:0.3 }),
            ...
            BaseScene.makeAssetSetup({ src: 'cloud-fog', onUpdate: this.loopLeft.bind(this),position: { x: 500, y: -100 }, scale: { x: 3, y: 3 }, anchor: { x: 0.5, y: 0.5 }, alpha:0.3 }),

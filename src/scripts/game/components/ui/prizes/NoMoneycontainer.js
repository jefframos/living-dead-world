...
export default class NoMoneycontainer extends MainScreenModal {
    constructor() {
        ...
        this.collectButton = UIUtils.getPrimaryLabelButton(() => {
            this.hide()
        }, LocalizationManager.instance.getLabel('CANCEL'))
    ...
    showInfo(data) {
        ...
        if (data.currency == 1) {
            ...
            this.currentCurrency = 1
            this.videoButton.priceLabel.text = LocalizationManager.instance.getLabel('FREE')+'\n500x'
        ...
        this.videoButton.buttonListContent.updateHorizontalList()
        this.youHaveLabel.text =  LocalizationManager.instance.getLabel('YOU_HAVE') +' ' + currentCurrency;
        this.currencyIcon.texture = PIXI.Texture.from(UIUtils.getIconUIIcon(data.texture));

        this.youNeedLabel.text = LocalizationManager.instance.getLabel('YOU_NEED') +' ' + targetCurrency;
        ...
        this.congratulationsLabel.text =  LocalizationManager.instance.getLabel('NOT_ENOUGH_CURRENCY')
